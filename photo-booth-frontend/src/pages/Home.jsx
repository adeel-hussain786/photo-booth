...
const pkgClassic     = "https://images.unsplash.com/photo-1502635385003-ee1e6a1a742d?w=700&q=80";
const pkg360         = "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=700&q=80";
const pkgAudio       = "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=700&q=80";
const pkgGuestBook   = "https://images.unsplash.com/photo-1464207687429-7505649dae38?w=700&q=80";
    ...
    <div className="app">
      ...
      <section ref={svcRef} style={{ background:"var(--ink, #0d0b08)" }}>
        <div className="section" style={{ maxWidth:"var(--max-w, 1280px)", margin:"0 auto", padding:"96px var(--gutter, 40px)" }}>
          ...
          {/* Services grid — 2 cols on tablet, 1 on mobile, 4 on desktop */}
          <div className="services-grid" style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:3 }}>
            {SERVICES.map((s,i)=>(
